using System;
using NET.W._2019.Gorodko._04.Task2.Task6Addition;
using NUnit.Framework;
using System.Collections.Generic;

namespace NET.W._2019.Gorodko._04.Tests.Task2.Task6Addition
{
    [TestFixture]
    public class JaggedArrayHelperTests
    {
        ...
        public void Sort_ArrayIsNull_ThrowsArgumentNullExcption()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => array.Sort(new ArrayComparer((a, b) => 1), true));
        }
        ...
        public void Sort_CompareIsNull_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => array.Sort((IComparer<int[]>)null, true));
        }
        ...
        public void Sort_CompareArraySum_ReturnsRightResult()
        {
            ...
            array.Sort(new ArrayComparer(ArrayComparer.CompareArraySum), true);
        ...
        public void Sort_CompareArrayMax_ReturnsRightResult()
        {
            ...
            array.Sort(new ArrayComparer(ArrayComparer.CompareArrayMax), true);
        ...
        public void Sort_CompareArrayMin_ReturnsRightResult()
        {
            ...
            array.Sort(new ArrayComparer(ArrayComparer.CompareArrayMin), true);
