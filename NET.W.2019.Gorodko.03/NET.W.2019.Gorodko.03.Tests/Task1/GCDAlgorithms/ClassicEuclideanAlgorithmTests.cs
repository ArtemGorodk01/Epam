...
{
    [TestFixture]
    public class ClassicEuclideanAlgorithmTests
    {
        [Test]
        public void Execute_ArgumentIs0_ThrowsArgumentException()
        {
            Assert.Throws<ArgumentException>(() => new ClassicEuclideanAlgorithm().Execute(0, 1));
            Assert.Throws<ArgumentException>(() => new ClassicEuclideanAlgorithm().Execute(1, 0));
        }
        ...
        {
            return new ClassicEuclideanAlgorithm().Execute(number1, number2);
        }
    }
}
